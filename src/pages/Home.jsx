      ...
      <div className="hero">
        <div className="hero__tab">
          <input
            type="checkbox"
            id="profile"
            className="checkbox-hack__input"
            defaultChecked
          />
          <label
            htmlFor="profile"
            style={{ borderRadius: "3rem 3rem 0 0" }}
            className="hero__label checkbox-hack__label"
          >
        ...
        {completeUser && (
          <>
            ...
            <div className="hero__tab">
              ...
              >
                <div className="center-V">
                  <BsFillPeopleFill style={{ marginRight: "1rem" }} /> Browse
                  Users
                </div>
              </label>
              <div className="checkbox-hack__body">
            ...
            <div className="hero__tab">
              ...
              >
                <div className="center-V">
                  <BsFillEmojiHeartEyesFill style={{ marginRight: "1rem" }} />{" "}
                  Matched Users
                  {newMsg.text && (
                    <BsEnvelope
                      style={{
